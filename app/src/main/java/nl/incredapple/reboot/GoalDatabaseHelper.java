...
public class GoalDatabaseHelper  extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_WHERE_WHEN_HOW = "mWhereWhenHow";
...
//                COLUMN_PRECISE + " STRING, " +
    ...
    public long insertData (String goal, String mWhereWhenHow, String more) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_GOAL, goal);
        contentValues.put(COLUMN_WHERE_WHEN_HOW, mWhereWhenHow);
